...
import sys
import os
os.environ['LD_LIBRARY_PATH']='$LD_LIBRARY_PATH:/home/qcj/.mujoco/mujoco210/bin:/usr/lib/nvidia'
sys.path.append("../../")
    ...
    def test_agent():
        ...
        for j in range(num_test_episodes):
            ...
            while not(d or (ep_len == max_ep_len)):
                ...
                res = test_env.step(get_action(replay_buffer.normalize_obs(o), True).squeeze())
                if len(res) == 5:
                    o, r, d, _, _ = res
                else:
                    o, r, d, _ = res
