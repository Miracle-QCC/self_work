...
if __name__ == "__main__":
    ...
    parser.add_argument("--previous", type=str, default=None)                           # path to directory of previous policies
    ...
    if len(sys.argv) < 2:
        ...
        parser.add_argument("--previous_", type=str, default=None)                           # path to directory of previous policies for resuming training
        parser.add_argument("--redis_address", type=str, default=None)                  # address of redis server (for cluster setups)
        ...
        parser.add_argument("--n_itr", type=int, default=99999, help="Number of iterations of the learning algorithm")
