...
from QMIXDDQN import Qmix_DDQN_Agent
...
while e < num_episodes:
    ...
    while not done:
        ...
        qmix_agent.put(obs0, obs1, a0,a1, shape_rewards[0] / 10,shape_rewards[1] / 10, obs0_next,obs1_next, done)
...
torch.save(qmix_agent.q1.state_dict(),'q1_6.pt')
torch.save(qmix_agent.q2.state_dict(),'q2_6.pt')
torch.save(qmix_agent.qmix.state_dict(),'qmix_6.pt')
