...
agent0 = DDQN_Agent(**params)
rnd0 = RND(96).to(device)
agent1 = DDQN_Agent(**params)
rnd1 = RND(96).to(device)
...
for e in range(num_episodes):
    ...
    while not done:
        ...
        agent0.put(obs0, a0, shape_rewards[0] / 10, obs0_next, done)
        agent1.put(obs1, a1, shape_rewards[1] / 10, obs1_next, done)
